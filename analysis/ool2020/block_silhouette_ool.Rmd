...
d.Eu.boot %>%
  ggplot(aes(x=phase_pair,y=empirical_stat, color=distance_type, fill=distance_type, group = distance_type)) +
    ...
    theme(legend.position = c(0.75, 0.88), legend.title=element_blank(), text = element_text(size=18), element_line(size=1), element_rect(size=2, color="#00000"))
...
```{r import.btw.ppt}
ppt.var <- read.csv('../results/csv/block_silhouette_Exp2Pilot3_ppt_variance_separate.csv')
