...
m1 <- lmer(data = d.conv, temporal_similarity ~ phase_pair + (1 | gameID) + (1 | targetName))
m2 <- lmer(data = d.conv, temporal_similarity ~ phase_pair + phase_a_rawF1DiscreteScore + (1 | gameID) + (1 | targetName))
m3 <- lmer(data = d.conv, temporal_similarity ~ phase_pair * phase_a_rawF1DiscreteScore + (1 | gameID) + (1 | targetName))
...
m1 <- lmer(data = d.conv, optimal_euclidean_distance ~ phase_pair + (1 | gameID) + (1 | targetName))
m2 <- lmer(data = d.conv, optimal_euclidean_distance ~ phase_pair + phase_a_rawF1DiscreteScore + (1 | gameID) + (1 | targetName))
m3 <- lmer(data = d.conv, optimal_euclidean_distance ~ phase_pair * phase_a_rawF1DiscreteScore + (1 | gameID) + (1 | targetName))
