...
var instructionsHTML = {
  'str1' : "<p> Here's how the game will work: On each trial, you will see the silhouette of a block tower on the left. Your goal is to reconstruct this tower on the right. You will be given 60 seconds to do this using as few blocks as possible. In other words, when you are finished you want both towers to look alike and in the same spot within their environments (not shifted over left or right). </p> <div><img src='assets/buildDemo.gif' id='example_screen'></div> <p> To build your tower, first select a block from the menu by clicking on it and then move your cursor to the building environment above. </p> <p> Be careful because your block will fall once you click so be sure to place the block exactly where you want it to rest by clicking the mouse again. </p> <p> You can use a block of a specific size as many times as you want. But note that you cannot move a block once it has been placed, and there is no way to 'undo' the placement of a block. </p> <p> Also note that your tower is subject to gravity: it is possible for it to become unstable and tip over. If this happens, you can clear the whole environment by clicking the Reset button. But try to avoid doing this too many times, because you may run out of time.",
