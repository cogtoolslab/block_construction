...
var instructionsHTML = {
  'str1' : "<p> Here's how the game will work: On each trial, you will see the silhouette of a block tower appear in the lefthand environment. Your goal is to reconstruct this tower in the righthand environment. You will be given 60 seconds to do this using as few blocks as possible. In other words, when you are finished you want both towers to look alike and in the same spot within their environments (not shifted over left or right). </p> <p> To build your tower, first select a block from the menu by clicking on it and then move your cursor to the construction environment above. Be careful becuase your block will fall once you click so be sure to place the block exactly where you want it to rest by clicking the mouse again. You can use a block of a specific size as many times as you want. But note that you cannot move a block once it has been placed<, and there is <b>no way to 'undo' the placement of a block</b>. Also note that your tower is subject to gravity: it is possible for it to become unstable and tip over. If this happens, you can clear the whole environment by clicking the Reset button. But try to avoid doing this too many times, because you may run out of time. <div><img src='assets/buildDemo.gif' id='example_screen'></div>",
  'str2' : "<p> There are 16 different block towers you will build in this HIT. , you will receive a <b> bonus</b> between $0.01 and $0.05.</p>",
  ...
  'str4' : "<p> Before we begin, let's get some practice with the building interface. On this practice trial, you will be shown the exact locations to place each block. Please place the blocks as precisely as you can to ensure that you have the opportunity to proceed and participate in the experiment. No bonus can be earned on this practice trial. Please note that after you place a block, you will not be able to select a new block or press 'Done' until all of the blocks have come to rest. </p>",
  'str5' : "<p> Please pay attention and do your best!</p>"
};

var secondInstructionsHTML = {
  'str1' : "<p> Note that in the main experiment you will not be shown where to place each block. However, there will be a small tick mark on the center of the floor in each environment to help you make sure your tower is in the correct location.</p>",
