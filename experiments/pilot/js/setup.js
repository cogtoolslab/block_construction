...
var secondInstructionsHTML = {
  ...
  'str3' : "<p> This is what the screen will look like when you have to think. It's impossible to grab blocks here.</p><div><img src='assets/internalDemo.gif' id='example_screen'></div>",
  'str4' : "<p> This is what the screen will look like when you are allowed to practice.</p><div><img src='assets/externalDemo.gif' id='example_screen'></div>",
  'str5' : "<p> To summarize, there will be two stages in each trial:</p><p><ul style='list-style: none;'><li> 1. <b>Plan,</b> Either by <b><font color='#FE5D26'>thinking</font></b> or by <b><font color='#6DEBFF'>building</font></b>.</li><li>2. <b>Build,<font color='#75E559'> for real</font>.</b></li></ul><p> There will be reminders throughout. That's the end of the instructions! Continue when you are ready to start the first trial.</p>"
}
