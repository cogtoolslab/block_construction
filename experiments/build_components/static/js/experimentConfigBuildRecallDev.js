expConfig = {
    ...
    "mainInstructions":['<p>In this study you will be presented with a series of <i>block towers</i> that look like this: </p><img src="../img/instruction_images/tower_example.png" style="max-width: 150px"><p>Afterwards, you will be asked some questions about the towers.</p> '],
    ...
    '<p>In the "<strong>BUILD</strong>" task, your goal is to <strong>perfectly reconstruct the tower</strong> on the left in the window on the right.</p><p>Click to pick up blocks and click again to place them. Blocks can be placed on on the ground or on top of other blocks, and will stay where they are when placed. You can undo/redo blocks with the undo/redo buttons or press "Reset" to start building again from scratch. You will move on once you have perfectly copied the tower anywhere in the building window.</p></br><img src="../img/instruction_images/tower_build_demo_undo.gif" style="max-width: 600px">',
    '<p>You may see the same tower more than once. Remember to pay close attention to all of the towers, as you will be asked about them later!</em></p><p>That\'s all you need to know for now. Press Next to start.</p>'],
    "decodePhaseInstructions":['<p>Great job! Now we want to see how well you remember the towers you have just seen.</p><p>On the next screen you\'ll be shown a new building window. Your task is to build as many towers as you can remember from the previous part of the study. Include towers that you built and looked at. In total there were 6 unique towers. Each can be built using 8 blocks. Once you have placed 8 blocks press "Submit" to save your tower and start another one.</p>',
